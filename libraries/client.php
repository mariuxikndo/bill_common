...
class Client {
    ...
    public function get_client_data($client_id) {
        ...
        $client_data = $this->ci->generic_model->get_join(
                    ...
                    $join_cluase, 
                    'c.PersonaComercio_cedulaRuc, c.nombres, c.apellidos, c.razonsocial razonsocial, c.direccion, c.diasCredito dias_credito, c.telefonos, c.celular, c.email, c.clientetipo_idclientetipo tipo_id, c.descuentomaxporcent desc_client, c.cupocredito cupo_credito, ct.descuento desc_ct', 
                    1 
                );
        return $client_data;
    }
